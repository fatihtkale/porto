                ...
                <div class="container">
                    <div class="d-inline">
                        <div class="cards" style="width: 20rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="#" class="btnwork">Go somewhere</a>
                            </div>
                        </div>
                    </div>
                    </section>
                    <section class="Hireus">
                        ...
                        <form action="" method="post">
                            ...
                            <p>
                                <textarea placeholder="test" name="message" id="message" class="contact-form"><?php if (isset($_POST['message']) === true) { echo strip_tags($_POST['message']); } ?> </textarea>
                            </p>
                            <p>
